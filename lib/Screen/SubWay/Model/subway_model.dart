class ApiResponse {
  ...
  factory ApiResponse.fromJson(Map<String, dynamic> json) {
    var list = json['realTimeArrival'] as List;
...
class RealTimeArrival {
  ...
  final String
      ordkey; //- String 01000방화0 도착예정열차순번 (상하행코드(1자리),순번(첫번째,두번째열차,1자리), 첫번째 도착예정 정류장 - 현재정류장(3자리),목자리 정류장,급행여부(1자리)))
  final String barvIDt; //- String 열차도착예정시간(단위:초)
  ...
  final String istcarAt; //- String 막차여부 (1:막차, 0:아님)
